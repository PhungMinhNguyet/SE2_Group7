...
<div id='header'>
        <div id='text_header'>
            ...
            <div id='hotline'>
                ...
                <p id='number_hotline'>Admin mode</p>
            </div>
        </div>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item dropdown">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<%=request.getContextPath()%>/listuser">Users</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<%=request.getContextPath()%>/listNew">News</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="<%=request.getContextPath()%>/vietnam">VietNam</a>
